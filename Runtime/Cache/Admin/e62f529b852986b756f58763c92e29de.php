    ...
    <div class="col-xs-12">
             <div class="tabbable">
                   <ul class="nav nav-tabs padding-12 tab-color-blue background-blue" id="myTab">
                       ...
                       <li><a href="<?php echo U('Admin/case/index',array('nav'=>I('nav')));?>">返回</a></li>
                   </ul>
                   <div class="tab-content">
                        <form class="" action="<?php echo U('order');?>" method="post">
                            ...
                            <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
                                    ...
                                    <td>
                                         <p><a href="javascript:;" vId="<?php echo ($v['id']); ?>" vName="<?php echo ($v['name']); ?>"  vName_en="<?php echo ($v['name_en']); ?>" vUrl="<?php echo ($v['url']); ?>" vUrl_en="<?php echo ($v['url_en']); ?>"  onclick="edit(this)">修改</a></p> 
