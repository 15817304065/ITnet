...
<head>
    ...
    <link rel="stylesheet" href="/ITnet/themes/Home//v1.0/css/product-icon.css"/>
    <link rel="stylesheet" href="/ITnet/themes/Home//v1.0/css/globe.css"/>
    <link rel="stylesheet" href="/ITnet/themes/Home//v1.0/css/index.css"/>
    <link rel="stylesheet" href="/ITnet/themes/Home//v1.0/css/index1.css"/>
                                    ...
                                    <nav class="navbar navbar-default" role="navigation">
                                        <div class="">
                                            <div class="navbar-header" style="float: left;">
                                                ...
                                                <a class="navbar-brand" href="<?php echo U('index/index_show');?>?lang=cn" target="_blank" style=" display:  inline-block; ">
                                                    ...
                                                    <div class="">
                                                      ...
                                                      <!--遍历顶部导航栏 -->    
                                                              <?php if(is_array($nav_top['_data'])): $i = 0; $__LIST__ = $nav_top['_data'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><li class="" data-toggle="navBarMenu" data-target="#dropdown-menu-bh-<?php echo ($i-1); ?>" aria-expanded="false" style="<?php if($i==1)echo 'padding-right: 20px';?>">
                                                                    <a  class="normal-cursor <?php if($i==1)echo 'aactive zerotitle';?>" onclick="return false;"><?php echo ($val["name"]); ?></a>
                                                                </li><?php endforeach; endif; else: echo "" ;endif; ?>
                                                         <!--遍历顶部导航栏 --> 
                                                            </ul>
                                                            <div class="clear"></div>
<script type="text/javascript">
     $('title').text('运营商行业营销作战平台'); 
</script>
                                                                        ...
                                                                        <div class="row row-eq-height clearfix">
                                                                            ...
                                                                            <div class="xtable">
                                                                                <table class="table table-bordered" style="border:  none; ">
                                                                                    ...
                                                                                    <thead>
                                                                                        <tr>
                                                                                             <?php if(is_array($width_arr['table1'])): $i = 0; $__LIST__ = $width_arr['table1'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><th style="text-align: <?php echo ($val["position"]); ?>;" width="<?php echo ($val["width"]); ?>"><?php echo ($val["name"]); ?></th><?php endforeach; endif; else: echo "" ;endif; ?>
                                                                                        </tr>
                                                                                    </thead>
                                                                                    <tbody>
   <!--遍历机会点地图 -->                                                                                     
                                                                                        ...
                                                                                        <?php  foreach ($case_data as $k => $v) { $num=0; $num += count($v['_data'])?count($v['_data']):1; $j=1; foreach ($v['_data'] as $a => $b) { ?>
                                                                                                ...
                                                                                                <td class="<?php if($j!=$num) echo 'bordernone';?>">
                                                                                                    <a <?php if($b['url']){echo "href=".$b['url'];}?>><?php echo ($b['name']); ?></a>
                                                                                                </td>

                                                                                                <?php  if($j==1){ ?>
                                                                                                     <td rowspan='<?php echo ($num); ?>' class="cxo">
                                                                                                         <a  <?php if($v['cxo_url']){echo "href=".$v['cxo_url'];}?>><?php echo ($v['cxo']); ?></a>
                                                                                                    </td>
                                                                                                    <td rowspan='<?php echo ($num); ?>' >
                                                                                                        <a  <?php if($v['solution_url']){echo "href=".$v['solution_url'];}?>><?php echo ($v['solution']); ?></a>
                                                                                                    </td>
                                                                                                    <td rowspan='<?php echo ($num); ?>'>
                                                                                                         <?php echo ($v['offering']); ?>
                                                                                                    </td>
                                                                        ...
                                                                        <div class="row row-eq-height clearfix">
                                                                            ...
                                                                            <div class="xtable2">
                                                                                <table class="table table-bordered" style="border:  none; ">
                                                                                    ...
                                                                                    <thead>
                                                                                       <tr>
                                                                                             <?php if(is_array($width_arr['table2'])): $i = 0; $__LIST__ = $width_arr['table2'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><th style="text-align: <?php echo ($val["position"]); ?>;" width="<?php echo ($val["width"]); ?>"><?php echo ($val["name"]); ?></th><?php endforeach; endif; else: echo "" ;endif; ?>
                                                                                        </tr>
                                                                                    </thead>
                                                                                    <tbody>
                                                                                       
                                                                                        <?php foreach($category_data[$y] as $k=>$v){ $count=0; $count += count($v['ziliao'])?count($v['ziliao']):1;?>
                                                                                         <tr>
                                                                                            <td rowspan="<?php echo ($count); ?>"><?php echo ($v['name']); ?></td>
                                  ...
                                  <!-- 导航栏遍历一级start -->     
                                             ...
                                             <?php if(is_array($nav_data)): $i = 0; $__LIST__ = $nav_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><!-- 加入配置的一级导航菜单 -->
                                                    <li class="header-allnav-common-item" data-key="nav<?php echo ($val["id"]); ?>">
                                                        <a target="_blank" href="<?php echo U($val['name_en']);?>?lang=cn"><?php echo ($val["name"]); ?></a>
                              ...
                              <!-- 导航栏遍历一级end -->     
                                     ...
                                     <!-- 遍历侧边栏start -->  
                                              <?php if(is_array($url_data[60])): $i = 0; $__LIST__ = $url_data[60];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><li class="header-allnav-common-item header-nav-hot">
                                                    <a mate_data_ts="www_v3_top_navigation.click.activity_20170820" href="<?php echo ($val["url"]); ?>"
                                                    ...
                                                    <li class="header-allnav-inner" data-name="nav<?php echo ($v['id']); ?>">
                                                         <ul class="header-allnav-common-list">
                                                               ...
                                                               <?php $j=0; foreach($v['_data'] as $key=>$val){ if($j!=0){ ?>
                                                                    <li class="header-allnav-common-item nav_child<?php echo ($val['id']); ?>"><?php echo ($val['name']); ?>
                                                                        <i class="header-icon-arrow-right"></i>
                                                                    </li>
                                                                  <?php if($x==0){ ?>
                                                                   <script type="text/javascript">
                                                                  ...
                                                                  <?php }else{ ?>
                                                                    <script type="text/javascript">
                                                                         $(".nav_child<?php echo ($val['id']); ?>").click(function() {
                                                                              ...
                                                                              // location.href="<?php echo U($v['name_en']);?>"+"?lang=cn&nid=<?php echo ($j); ?>"
                                                                          });
                                                                   </script>
                                                                <?php }}?>
                                                               <?php $j++; }?>
        ...
        <div class="layout layout-grid-0">
                    ...
                    <div class="main-wrap J_Region">
                        <div class="alicloud-v3-home-carousel J_Module">
                            <div id="carousel-home" class="carousel slide" data-ride="carousel">
                                <img src="/ITnet/themes/Home//v1.0/img/bg.jpg" alt="" style="width: 100%;height: 100%;"/>
                            </div>
            ...
            <!-- 遍历底部外链 --> 
                       <?php if(is_array($url_data[61])): $i = 0; $__LIST__ = $url_data[61];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><div class="col-md-3 col-sm-3 col-xs-6">
                                    <a class="sbdemand" href="<?php echo ($val['url']); ?>">
                                        <div class="default-status">
                                            <div class="default-icon">
                                                <img   src="/ITnet<?php echo ($val['img']); ?>"/>
                                            </div>
    ...
    <script src="/ITnet/themes/Home//v1.0/js/globe.js"></script>
    <script src="/ITnet/themes/Home//v1.0/js/index.js"></script>
</body>
</html>